...
export interface ApiAssessmentAssessment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    assessment_file: Schema.Attribute.Media<
...
export interface ApiProfileResidentProfileResident
  extends Struct.CollectionTypeSchema {
...
export interface ApiProgramSkillProgramSkill
  extends Struct.CollectionTypeSchema {
  collectionName: 'program_skills';
  info: {
    displayName: 'Program Skill';
    pluralName: 'program-skills';
    singularName: 'program-skill';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProgramStatusProgramStatus
  extends Struct.CollectionTypeSchema {
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activity_name: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_of_upload: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::report.report'
...
export interface ApiResidentFieldResidentField
  ...
  attributes: {
    activity_date: Schema.Attribute.Date;
    activity_upload: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiResidentProgramResidentProgram
  extends Struct.CollectionTypeSchema {
